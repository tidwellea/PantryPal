...
public class FridgeAdapter extends CursorAdapter {
    ...
    public FridgeAdapter(Context context, Cursor c, int flags) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        FridgeViewHolder viewHolder = new FridgeViewHolder(foodItem);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        FridgeViewHolder holder = (FridgeViewHolder) view.getTag();
    ...
    private class FridgeViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
